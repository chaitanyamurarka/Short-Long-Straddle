...
# from real import short_net_quant_zero,short_get_symbol_lotsize,long_get_symbol_lotsize,place_order,get_name_from_instrument_token,cal_dates,short_straddle,long_straddle,short_get_instru_tradesymbol_pe_from_ce,long_get_instru_tradesymbol_pe_from_ce,long_net_quant_zero,cal_sec_last_thurs
