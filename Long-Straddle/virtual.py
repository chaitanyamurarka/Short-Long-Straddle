                    ...
                    if (tradingsymbol_ce is not None and lot_size_ce is not None and tradingsymbol_pe is not None and lot_size_pe is not None):
                        ...
                        try:
                            ...
                            insert_data_query = '''
                                ...
                                VALUES (?, ?, ?,?,?);
                            '''
                            data_to_insert = (tradingsymbol_ce, lot_size_ce*val,instru_ce,ltp_ce,datetime.now(IST))
                            cursor.execute(insert_data_query, data_to_insert)
                            data_to_insert = (tradingsymbol_pe, lot_size_pe*val,instru_pe,ltp_pe,datetime.now(IST))
                            cursor.execute(insert_data_query, data_to_insert)
